...
export { default as HOF } from './hallOfFame/HOF'
export { default as PhotoCollage } from './photoCollage/PhotoCollage'
export { default as MiniProj } from './miniProj/MiniProj'