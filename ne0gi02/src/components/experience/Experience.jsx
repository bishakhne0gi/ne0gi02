        ...
        <>
            <div className="experience_container section__padding">
                ...
                <div className="container_experience section__padding">
                    ...
                    <img className="ig it8" src={ISC} data-aos="flip-up" data-aos-easing="linear" data-aos-duration="500"></img>
                    ...
                    <img className="ig it18" src={ISC} data-aos="flip-up" data-aos-easing="linear" data-aos-duration="500"></img>
